...
public class LambdaExample {
    ...
    public static void main(final String[] args) {
       ...
       ///  4
        ...
        // TODO With functional interfaces declared
        Predicate<User> UserAgeLessThan_10_Predicate = new Predicate<User>() {
            @Override
            public boolean test(User user) {
                return user.age < 10;
            }
        };
        Comparator<User> AgeSorting = new Comparator<User>() {
            @Override
        ...
        repository.select(UserAgeLessThan_10_Predicate, AgeSorting);
        banner("Listing users with age < 10 sorted by age - lambda");
        // TODO With functional interfaces used directly
        repository.select(user -> user.age < 10, (o1, o2) -> (o1.age < o2.age ? -1 : (o1.age == o2.age ? 0 : 1)));
        ...
        Comparator<User> UserNameComparator = new Comparator<User>() {
            @Override
            public int compare(User o1, User o2) {
                return (o1.name.compareTo(o2.name));
            }
        };
        repository.select(ActiveUsersPredicate , UserNameComparator);
        ...
        // TODO With functional interfaces declared
        Predicate<User> ActiveUsersWithAgeGreaterThan_8 = new Predicate<User>(){
            @Override
            public boolean test(User user){
        ...
        repository.select(ActiveUsersWithAgeGreaterThan_8 , SortByName);
